...
function getPreloadedImages() {
    ...
    var assets = [
		...
		"img/logo-inria-medium_2x.png",
		"img/apple-touch-icon-60x60.png",
		"img/icn-arrow-left_2x.png",
		"img/logo-digital-cuisine-medium_2x.png",
		"img/favicon.ico",
		...
		"img/icn-space.png",
		"img/icn-arrow-right_2x.png",
		"img/entangled-cables-L-01.png",
		"img/icn-gp-large.png",
		"img/logo-digital-cuisine-medium-2_2x.png",
