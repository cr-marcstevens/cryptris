    ...
    */
    ...
    if (animatePlayScene !== true) {
        ...
        $(document).on('padlockIsFall', function() {
            if (withIaBoard) {
                ...
                if (rivalMessage.boxOption.endResolved === null && rivalMessage.resolved === true && rivalPadlockIsFall === true) {
                    ...
                    rivalBoxInfo.addWinScreen(lang.DIALOG_STRING71, 200, 50, true, resultScene.scene, hookActive);
                    gameBoxInfo.addWinScreen(lang.TXT_FAILURE, 200, 50, false);
                }
            }
            ...
            if (gameMessage.boxOption.endResolved === null && gameMessage.resolved === true && gamePadlockIsFall === true) {
                ...
                gameBoxInfo.addWinScreen(lang.DIALOG_STRING71, 200, 50, true, resultScene.scene, hookActive);

                if (withIaBoard) {
                    rivalBoxInfo.addWinScreen(lang.TXT_FAILURE, 200, 50, false);
                }
            }
        });
        ...
        $(document).on('endAnimate', function() {
            gameBoxInfo.addWinScreen(lang.DIALOG_STRING70, 200, 50, true, resultScene.scene, hookActive);
        });
    }
