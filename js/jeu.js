 ...
 */
    ...
    var url         = cryptrisSettings.appUrl,
        hrefPath    = url,
        title       = lang.CRYPTRIS_HTMLTITLE,
        text        = lang.DIALOG_STRING63,
    ...
    var fbUrl = fbBase+"&caption=" + title + "&description=" + text + "&link=" + url + "&picture=" + preview_xl + "&redirect_uri="+cryptrisSettings.appUrl+lang.THANKS_HTMLFILE;
